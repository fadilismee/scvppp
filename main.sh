...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/fadilismee/scvppp/main/"
start=$(date +%s)
secs_to_human() {
...
wget raw.githubusercontent.com/fadilismee/scvppp/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/fadilismee/scvppp/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/fadilismee/scvppp/main/Cfg/m-noobz 
